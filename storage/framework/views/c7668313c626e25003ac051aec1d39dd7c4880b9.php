        ...
        <div id="line-one">
            <div class="container">
                ...
                <div class="row">  
                    ...
                    <br> 
                    <form method="post" 
                          action="<?php echo e(route('filme.update', $filme->id)); ?>"
                        ...
                        <div class="col-md-6">              
                            <div class="form-group">
                                ...
                                <input type="text" name="strtitulo" 
                                       class="form-control" 
                                       value="<?php echo e(isset($filme->strtitulo)? $film->strtitulo : old('strtitulo')); ?>"
                                       required> 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="strdescricao">Descrição</label>
                                <input type="text" name="strdescricao" 
                                       class="form-control" 
                                       value="<?php echo e(isset($film->strdescricao)? $film->strdescricao : old('strdescricao')); ?>"
                                       required>
                            </div>
                        </div>
